  ...
  <el-dialog v-model="dialogVisible" title="新增参数" width="380" center @close="onClose">
    <el-form :model="form" :rules="rules" label-position="top" ref="formRef">
      <el-form-item label="参数名称" prop="label">
        <el-input v-model="form.label" autocomplete="off" maxlength="50" placeholder="请输入参数名称" clearable
          :formatter="(value:string) => value.replace(/\s/g, '')"/>
      </el-form-item>
      <el-form-item label="参数值" prop="value">
        <el-input v-model="form.value" autocomplete="off" maxlength="100" placeholder="请输入参数值" clearable
          :formatter="(value:string) => value.replace(/\s/g, '')" />
      </el-form-item>
    </el-form>
    <template #footer>
