<template>
  <el-card style="max-width: 800px; margin: 30px auto" shadow="hover">
    ...
    <div class="qrcode-container" v-show="!!qrCodeDataUrl">
      <el-text type="warning" line-clamp="100" style="word-break: break-word">
        {{ qrCodeUrl }}
      </el-text>
      <img :src="qrCodeDataUrl" alt="QR Code" />
      <el-link type="primary" underline="never" download="qrcode.png" :href="qrCodeDataUrl">
        保存到本地
      </el-link>
    </div>
  </el-card>
...
const rules = {
  ...
  custom: [{ required: true, message: '请输入自定义网址', trigger: 'blur' }],
};
